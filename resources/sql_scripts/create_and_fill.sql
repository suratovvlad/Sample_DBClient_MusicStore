...
INSERT INTO `album` (`idAlbum`,`title`,`cover`,`year`,`volumeType`,`recordType`,`price`,`Rockband_idRockband`) VALUES (1,'Appetite for Destruction',?,1987,'LP','Studio Album',14.99,1);
